...
@implementation EditPhotoTableView
...
- (void)viewDidLoad {
	...
	self.preferredContentSize = CGSizeMake(168.0, 88.0);
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    // Configure the cell...
    if ([indexPath row] == 0) {
		[[cell textLabel] setText:NSLocalizedString(@"Choose Photo", @"Choose photo")];
	}
	else {
		[[cell textLabel] setText:NSLocalizedString(@"Delete Photo", @"Delete photo")];
	}
